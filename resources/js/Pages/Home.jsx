...
export default function Home () {
    const { total =60, compulsory=50, electives=40, hours=80 } = usePage().props;
    const disciplines = [
        { id: 1, name: "Cálculo 2", status: "yes" },
        { id: 2, name: "Programação 3", status: "no" },
        { id: 3, name: "Redes de Computadores", status: "yes" },
        { id: 4, name: "Teoria dos Grafos", status: "maybe"}
    ]
        ...
        <>
            <div className="w-full h-screen flex flex-col items-center font-roboto">
                <div className="w-3/4 flex flex-col items-center">
                    ...
                    <div className="lg:w-1/2 w-full h-full flex flex-col text-center items-center border rounded-2xl border-purple-dark shadow-xl p-4 mb-12">
                    ...
                    <div className="lg:w-3/4 h-full flex flex-col items-center border rounded-2xl border-purple-dark shadow-xl p-4">
                    ...
                    <div className="w-full flex lg:flex-row flex-col items-center lg:mb-12">
                        <div className="lg:w-1/3 w-full h-full border border-purple-dark rounded-2xl flex flex-col items-center justify-center shadow-xl lg:mr-4 mb-8 p-4">
                        ...
                        <div className="lg:w-1/3 w-full h-full border border-purple-dark rounded-2xl flex flex-col items-center justify-center shadow-xl lg:mr-4 lg:ml-4 mb-8 p-4">
                        ...
                        <div className="hidden lg:block w-0.5 h-2/3 bg-purple-dark mb-8"></div>
                        <div className="lg:w-1/3 w-full h-full border border-purple-dark rounded-2xl flex flex-col items-center justify-center shadow-xl lg:ml-4 mb-8 p-4">
